...
SCOPED_TEST_LABELS = (
    ...
    "wallets.tests.test_submission_families.ScopedSubmissionFamilyTest",
    "wallets.tests.test_submission_token_families.ScopedTokenFamilyTest",
    "wallets.tests.test_submission_family_concurrency.ScopedSubmissionFamilyConcurrencyTest",
    "wallets.tests.test_submission_family_sync_race.ScopedFirstFamilySyncTest",
