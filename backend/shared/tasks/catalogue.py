SYSTEM_WIDE = {
    ...
    "whitelist.tasks.sync.reconcile_failed_adds": "Asks the chain about every entry recorded failed inside the "
    "window a node holds a transaction, which is a question about the deployment's one whitelist rather than "
    "about whoever owns any wallet on it.",
