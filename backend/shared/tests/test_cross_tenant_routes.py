...
ROUTES = (
    ...
    Route("get", "/api/portfolios/{portfolio}/allocations/"),
    ...
    Route("get", "/api/asset-allocations/{allocation}/"),
    Route(
        "put",
        "/api/asset-allocations/{allocation}/",
        {"portfolio": "{own_portfolio}", "asset": "{asset}", "percentage": "10.00"},
    ),
    Route("patch", "/api/asset-allocations/{allocation}/", {"percentage": "10.00"}),
    Route("delete", "/api/asset-allocations/{allocation}/"),
    Route("delete", "/api/asset-allocations/by-portfolio/{portfolio}/"),
    Route(
        "post",
        "/api/asset-allocations/",
        {"portfolio": "{portfolio}", "asset": "{spare_asset}", "percentage": "5.00"},
        foreign=400,
    ),
